...
const Technologies = () => {
  ...
  return (
    <section className=" w-full pb-16  sm:px-8 pt-28">
        ...
        <h3 ref={title} className="sm:text-5xl max-w-3xl translate-y-16 opacity-0 text-3xl text-center font-extrabold text-slate-900">Les Frameworks avec lesquels nous travaillons</h3>
        {/* cards container */}
...
const Card =({item})=>{
    return(
        <div className="w-full gap-y-6 outline outline-sky-100 shadow-lg rounded-xl  overflow-hidden group   relative flex flex-col items-start justify-between h-[33rem]">
            ...
            <div className="absolute left-[50%] -translate-x-[50%] bottom-8 h-4 w-[calc(100%-2rem)] border-t border-t-gray-300">
