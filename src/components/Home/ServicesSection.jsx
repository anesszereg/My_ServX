...
const ServicesSection = () => {
  ...
  const cards = [
    ...
    {
      title: "Crée des sites E-commerce",
      text: "L'e-commerce est trée important car il permet aux entreprises de vendre en ligne et aux consommateurs  d'achter facilement , oú qu'ils soient .",
      link: "/marketting",
      icon: (
  ...
  return (
    <div className="md:h-96 h-80 relative  hover:-translate-y-3   group transition-all duration-500 ease-in-out  py-4 outline outline-2 outline-sky-100 rounded-xl from-white to-white w-full px-2  sm:px-4 shadow-lg">
      ...
      <div className="gap-y-4 relative z-[1] flex flex-col items-center">
        ...
        <Link href={item.link} className="md:text-xl text-lg mt-2 font-bold transition-colors ease-in-out duration-75 group-hover:text-white flex items-center  gap-2 text-slate-900">
